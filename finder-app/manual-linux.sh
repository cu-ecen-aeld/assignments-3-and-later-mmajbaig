...
TOOLCHAIN_PATH=/home/ahsan/linux_course/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-linux-gnu/
...
sed -i 's|assignment=`cat ../conf/assignment.txt`|assignment=`cat conf/assignment.txt`|' finder-test.sh
